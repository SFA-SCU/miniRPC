...
public class RpcClientInvoker extends AbstractInvoker<RpcMessage> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(cn.scu.rpc.client.RpcClientInvoker.class);
    ...
    private final ThreadLocal<RpcRequest> rpcRequestThreadLocal = new InheritableThreadLocal<RpcRequest>();
